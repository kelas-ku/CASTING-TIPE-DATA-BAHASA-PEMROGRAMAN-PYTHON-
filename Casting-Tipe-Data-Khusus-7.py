...
# Dengan menggunakan semua nilai variabel tipe data (int, float, str, bool)
...
# Data awal
data_tuple = (10, 9.8, 'Haii', True, "Hello", False)
data_list = [False, "Hello", True, 'Haii', 9.8, 10]
data_set = {True, 'Haii', 9.8, "Hello", False, 10}
data_dict = {
	"int": 10,
	"float": 9.8,
	"str": 'Haii',
