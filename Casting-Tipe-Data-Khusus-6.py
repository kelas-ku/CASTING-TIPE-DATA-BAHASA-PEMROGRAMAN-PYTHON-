# Casting Tipe Data Khusus 5
# Dengan menggunakan nilai variabel bool (boolean) False
...
data_dict = {"nama": False, "umur": False}

# Khusus casting ke dict (dictionary)
data_tuple_dict = ({"nama": False, "umur": False},)
data_list_dict = [{"nama": False, "umur": False}]
data_set_dict = ({"nama": False, "umur": False},)
