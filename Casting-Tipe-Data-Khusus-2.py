# Casting Tipe Data Khusus 2
# Dengan menggunakan nilai variabel float
...
# Data awal
data_tuple = (1.1, 2.2, 3.3)
data_list = [3.3, 2.2, 1.1]
data_set = {4.4, 5.5, 6.6}
data_dict = {"nama": "Zeth", "umur": 2.1}

# Khusus casting ke dict (dictionary)
data_tuple_dict = ({"nama": "Zeth", "umur": 2.1},)
data_list_dict = [{"nama": "Zeth", "umur": 2.1}]
data_set_dict = ({"nama": "Zeth", "umur": 2.1},)
