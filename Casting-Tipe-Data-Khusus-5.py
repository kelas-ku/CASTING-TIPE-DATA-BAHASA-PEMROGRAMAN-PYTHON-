...
# Dengan menggunakan nilai variabel bool (boolean) True
...
data_dict = {"nama": True, "umur": True}

# Khusus casting ke dict (dictionary)
data_tuple_dict = ({"nama": True, "umur": True},)
data_list_dict = [{"nama": True, "umur": True}]
data_set_dict = ({"nama": True, "umur": True},)
